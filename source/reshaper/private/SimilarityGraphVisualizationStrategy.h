...
class SimilarityGraphVisualizationStrategy: public ILaTeXVisualizationStrategy<Graph>
{
public:
...
template<typename Graph>
void SimilarityGraphVisualizationStrategy<Graph>::writeFile(const Graph& graph, const std::tuple<int, int>& imageDims,
...
template<typename Graph>
void SimilarityGraphVisualizationStrategy<Graph>::writeHeader(const Graph& graph, std::ostream& output) const noexcept
{
...
template<typename Graph>
void SimilarityGraphVisualizationStrategy<Graph>::writeDocument(const Graph& graph, const std::tuple<int, int>& imageDims,
                                                     std::ostream& output) const noexcept
{
...
template<typename Graph>
void SimilarityGraphVisualizationStrategy<Graph>::writeTikzPicture(const Graph& graph, const std::tuple<int, int>& imageDims,
                                                        std::ostream& output) const noexcept
{
...
template<typename Graph>
void SimilarityGraphVisualizationStrategy<Graph>::writeTikzStyles(const Graph& graph, std::ostream& output) const noexcept
{
    boost::ignore_unused_variable_warning(graph);
